...
public class Exercise_Type_Adapter extends AppCompatActivity implements AdapterView.OnItemClickListener
{
    RatingBar ratingBar;
    GridView list;
    ArrayList<exercise_nameBean> yogaList;
    exercises_adapter yogaAdapter;
    ...
    void init()
    {
        ...
        ratingBar = (RatingBar) findViewById(R.id.fav);
    ...
    void QueryFromDB() {
        ...
        while (cursor.moveToNext())
        {
            ...
            yogaList.add(new exercise_nameBean(Name_E, image, fav_id, exercise_id));
        }
        cursor.close();
        yogaAdapter = new exercises_adapter(this, R.layout.grid_list_item, yogaList);
...
//            Toast.makeText(this, keyExerciseType, Toast.LENGTH_LONG).show();
        }
            ...
            public void onClick(DialogInterface dialog, int which) {
                switch (which) {
                    case 0:
                        if (IsNetworkConnected())
                        {
                            if (loginflag) {
                                ...
                                yogaList.set(pos, new exercise_nameBean(eb.getExercise_name(), eb.getExercise_image(), eb.getFav_id(), eb.getId()));
                                yogaAdapter.notifyDataSetChanged();
                            }
                            else
                                {
                                Toast.makeText(Exercise_Type_Adapter.this, "First Register Yourself to use this Feature", Toast.LENGTH_LONG).show();
                                }
                        }
                    ...
                    case 1:
                        QueryFromDB1();
                        put_IN_YOGABEAN();
                        Intent j = new Intent(Exercise_Type_Adapter.this, Exercise_Details.class);
    ...
    void insertFAVInCLoud()
    {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST,YogaUtil.INSERT_FAV, new Response.Listener<String>()
        {
            ...
            public void onResponse(String response)
            {
                ...
                Toast.makeText(Exercise_Type_Adapter.this,"Response is: "+ response,Toast.LENGTH_LONG).show();
                ...
                new Response.ErrorListener()
                {
                    ...
                    public void onErrorResponse(VolleyError error)
                    {
                        ...
                        Toast.makeText(Exercise_Type_Adapter.this,"That didn't work!"+error.getMessage(),Toast.LENGTH_LONG).show();
