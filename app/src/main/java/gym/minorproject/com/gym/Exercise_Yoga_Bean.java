...
public class Exercise_Yoga_Bean implements Serializable
{
    String Name_E;

    public Exercise_Yoga_Bean(String name_E, String name_H, String steps, String benefits, String contraindications,
