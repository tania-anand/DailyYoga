        ...
        implements NavigationView.OnNavigationItemSelectedListener,AdapterView.OnItemClickListener
{
    ...
    void QueryFromDB()
    {
        ...
        while(cursor.moveToNext())
        {
            ...
            yogaList.add(new exercise_nameBean(Exercise_Name,Exercise_Image));
        }
        cursor.close();
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        txtnavText =(TextView)header.findViewById(R.id.nav_header_text);
    ...
    public boolean onNavigationItemSelected(MenuItem item)
    {
        ...
        switch(id) {
            ...
            case R.id.rate_us :
               i = new Intent(MainYoga.this, Rate_US.class);
                startActivity(i);
                break;

            case R.id.nav_about_us :
                i = new Intent(MainYoga.this, About_Us.class);
                startActivity(i);
                break;
            ...
            case R.id.nav_user:
                ...
                {
                    i = new Intent(MainYoga.this,Yoga_Login.class);
                    startActivity(i);
                }
                break;
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id)
    {
        ...
        switch(bean.getExercise_name())
        {
            case YogaUtil.SITTING:
                i = new Intent(MainYoga.this,Exercise_Type_Adapter.class);
